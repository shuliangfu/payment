...
> 一个兼容 Deno 和 Bun 的统一支付集成库，支持 8 种支付方式，提供多币种转换和对账工具
...
统一支付库提供多种支付方式的集成能力，包括国际支付、国内支付和 Web3 加密货币支付。纯 TypeScript 实现，统一 API 设计，适用于电商平台、订阅服务、数字支付等场景。
